  ...
  while(receiver.hasWaitingMessages()){
    ...
    if(m.getAddress() == "/scene"){
      switch( m.getArgAsInt32(0) ){
        ...
        case 3  : delete basedraw; basedraw = new baribari();    break; //me
        ...
        case 12 : delete basedraw; basedraw = new Relation();    break; //Relation
        case 13 : delete basedraw; basedraw = new lines();       break; //hibisake
        case 14 : delete basedraw; basedraw = new baribari();    break; //baribari
        case 15 : delete basedraw; basedraw = new flyaway2();    break; //tondeku
